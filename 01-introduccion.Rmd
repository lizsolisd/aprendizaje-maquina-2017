...
% La línea gris es mejor que la roja, ajusta mejor y es más coherente. No es muy probable que por 1400 vuelva a subir y luego en 1500 baje otra vez la curva.
...
% Dependiendo del problema en lugar de perdida cuadratica, se sugiere utilizar el valor absoluto para que las diferencias no se hagan mas pequeñas si nos inferiores a 1 o sean más grandes si son mayores a 1.
%Se hace generan dos muestras: una para entrenar el modelo y el otro para calcular el error (hacer el test y ver como se comporta)
...
%La gris es como más generalizada e intuitivamente es la mejor, aprende de los datos. Es el que predice en error de prueba mejor
